    ...
    public CustomerSignIn()
    {
		 ...
		 b1.button.addActionListener(new ActionListener()
		 {
			 ...
			 public void actionPerformed(ActionEvent e)
			 {
				...
				if(database.CustomerSignIn(email, password)==true)
				{
					dispose();
					new SignedInCustomer(email);
				}
				else
				{
		 ...
		 b4.button.addActionListener(new ActionListener()
		 {
			 ...
			 public void actionPerformed(ActionEvent e)
			 {
				 String customerName = txt3.text.getText();
				 ...
				 String customerNameRegex = "^[a-zA-Z\\s]{1,20}$";
				 ...
				 {
					if(database.getCustomerEmail(email)==true)
					{
						database.customerRegister(customerName, email, phoneNumber, address, password);
